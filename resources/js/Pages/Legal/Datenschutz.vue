...
<template>
  <MainLayout title="Datenschutz" :show-footer="true">
    <div class="max-w-3xl mx-auto px-6 py-16 space-y-8">
      <h1 class="text-3xl font-bold text-gg-dark">Datenschutzerklärung</h1>
  ...
  <p>Linus Thaler, Innsbrucker Straße 37, 86163 Augsburg, Deutschland<br>E-Mail: <a href="mailto:greengains@outlook.de">greengains@outlook.de</a></p>
        ...
        <p>Bereitstellung der Website, Auslieferung digitaler Produkte, Kommunikation, Sicherheit und Betrugsprävention.</p>
        <h2>4. Rechtsgrundlagen</h2>
        <p>Art. 6 Abs. 1 lit. b DSGVO (Vertrag), lit. f (berechtigtes Interesse: Betrieb & Sicherheit), ggf. lit. a (Einwilligung).</p>
        <h2>5. Einsatz von Digistore24</h2>
        <p>Beim Kauf werden Daten über den Zahlungsdienstleister Digistore24 verarbeitet. Es gelten deren Datenschutzbestimmungen.</p>
        <h2>6. Speicherdauer</h2>
        <p>Daten werden gelöscht, sobald der Zweck entfällt oder gesetzliche Aufbewahrungsfristen ablaufen.</p>
        <h2>7. Ihre Rechte</h2>
        <p>Auskunft, Berichtigung, Löschung, Einschränkung, Widerspruch, Datenübertragbarkeit, Beschwerde bei einer Aufsichtsbehörde.</p>
        <h2>8. Sicherheit</h2>
